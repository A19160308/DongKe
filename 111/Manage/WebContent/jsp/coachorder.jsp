...
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
		...
		<fieldset class="layui-elem-field layui-field-title"
			...
			<legend>健身教练预定</legend>
		</fieldset>
		<div class="layui-fluid">

			<div style="margin: 0 auto;">

				<div style="margin: 0 415px; width: 602px;">
						 ...
						 /*  console.log('=='+data.data); */
						    ...
						    ,cols: [[
						 	 ...
						 	 table.on('tool(demo)', function(bb){
								    var data = bb.data;
								    if(bb.event === 'delete'){
								    	layer.confirm('你确定要预定该教练吗？', {
								    		  btn: ['确定','取消'] //按钮
								    		}, function(){
								    			//写请求
								    			var aa = data.coachid;
								    			$.post("http://localhost:8080/Manage/jsp/deleteCoach",{"coachid":aa},function(obj){								    				
								    					window.location.href = '${pageContext.request.contextPath}/jsp/coachorder.jsp';
							    			});
								    		}, function(){
								    		  layer.msg('已取消', {
								    		    time: 1000
