...
<body class="layui-layout-body">
    ...
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="delete">删除</a>
			...
			function creatTab(){//查询题目选择				
				$.post('${pageContext.request.contextPath}/jsp/getAllUsers',function(data){
					...
					layui.use('table', function(){
						 ...
						 /*  console.log('=='+data.data); */
						    ...
						    ,data:data.data
						    ,cols: [[
						      {field:'userid', width:150, title: '会员ID ',fixed:"left"}
						      ,{field:'username', width:150, title: '会员姓名'}
						      ,{field:'userpasswd', width:150, title: '会员密码'}
						 	 ...
						 	 table.on('tool(demo)', function(bb){
								    var data = bb.data;
								    if(bb.event === 'add'){
								    	layer.confirm('确定新增加会员吗？', {
								    		  btn: ['确定','取消'] //按钮
								    		}, function(){
								    			//写请求
								    			var aa = data.coachid;
								    			$.post("http://localhost:8080/Manage/jsp/addusers",{},function(obj){								    				
								    ...
								    if(bb.event === 'delete'){
								    	layer.confirm('你确定要删除该会员吗？', {
								    		  btn: ['确定','取消'] //按钮
								    			...
								    			//写请求
								    			var aa = data.userid;
								    			$.post("http://localhost:8080/Manage/jsp/deleteUsers",{"userid":aa},function(obj){								    				
								    					window.location.href = 'adcontrolusers.jsp';
								    			});
								    		}, function(){
								    		  layer.msg('已取消', {
								    		    time: 1000
