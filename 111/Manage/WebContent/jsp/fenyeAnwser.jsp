...
<!-- 
		...
		<table align="center" border="1" bgcolor="#FFFFFF"  >
			...
			<tbody id="listTbody"></tbody>
                            ...
                            <a href="http://localhost:8080/Manage/jsp/fenyeAnwser.jsp?page=${paging.indexpage-1}">&lt;&lt; 首页 </a>
                            <a href="http://localhost:8080/Manage/jsp/fenyeAnwser.jsp?page=${paging.page-1 }">    &lt; 上一页 </a>
                            <strong>第${paging.page+1}页/共${paging.pagenumber}页</strong>
                            <a href="http://localhost:8080/Manage/jsp/fenyeAnwser.jsp?page=${paging.page+1}">下一页 &gt;</a>
                            <a href="http://localhost:8080/Manage/jsp/fenyeAnwser.jsp?page=${paging.pagenumber-1}">末页 &gt;&gt;</a>
                        </p>
