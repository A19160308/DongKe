		...
		<div class="layui-side layui-bg-black">
			<div class="layui-side-scroll">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					...
					<li class="layui-nav-item"><a href="modifymessage.jsp">留言管理</a></li>
				</ul>
			</div>
		</div>
...
function insertcoach(){
	 		...
	 		$.ajax({					
				type:"post",
				url:"${pageContext.request.contextPath}/jsp/modifyMessage",
				dataType:'json',
				data:{
			...
			<div class="layui-form-item"
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						<label
							padding: 20px 20px; width: 80px; font-weight: 400; line-height: 20px;style="text-align: right; margin-right: 600px;">留言内容</label>
						<div class="layui-input-inline">
							<input class="layui-input" id="messageboard">
						</div>
					</div>
