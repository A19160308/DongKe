...
function register(){
			...
			var password=$("#password").val();
			  $.ajax({					
						type:"post",
						url:"${pageContext.request.contextPath}/plant/registerTea",
						dataType:'json',
						data:{
							username:username,
			    		 ...
			    		 success : function(data) {
			    		     ...
			    		     if(status==1){			    		    	 
			    			   alert("新增教师成功！");			    			  
			    			   var href = '${pageContext.request.contextPath}/jsp/tea_message.jsp';
			...
			<div class="layui-form-item"
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						<label
							padding: 20px 20px; width: 80px; font-weight: 400; line-height: 20px;style="text-align: right; margin-right: 600px;">教师姓名：</label>
						<div class="layui-input-inline">
							<input class="layui-input" placeholder="账号" id="username">
						</div>
					</div>
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							<label
								padding: 20px 20px; width: 80px; font-weight: 400; line-height: 20px;style="text-align: right; margin-right: 600px;">教师学工号：</label>
							<div class="layui-input-inline">
