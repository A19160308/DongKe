...
function insertcoach(){
			...
			var epprice=$("#epprice").val();
			  $.ajax({					
						type:"post",
						url:"${pageContext.request.contextPath}/plant/insertTea",
						dataType:'json',
						data:{
							epname:epname,
							epprice:epprice,
			...
			<div class="layui-form-item"
				...
				<div class="layui-form-item">
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							<label
								padding: 20px 20px; width: 80px; font-weight: 400; line-height: 20px;style="text-align: right; margin-right: 600px;">教师工号(密码)</label>
							<div class="layui-input-inline">
